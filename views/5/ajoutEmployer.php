...
<!-- Ajouter un employer -->
<div class="row">           
  <div class="col-md-12" id="ajoutEmployer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" style="max-width: 1000px!important;"  role="document">
   ...
   <div class="modal-body row">         
    ...
    <input type="file" name="image" id="image" class="form-control"  placeholder="Choisir une photo de profil" />
    </div><br/>
    <div class="col-md-6">
    <!-- <label>Code IPMIE </label>
    <input type="number" name="codeipmie" id="codeipmie" class="form-control"  placeholder="codeipmie" required />
    <label>Code IPMIE </label>
    <input type="number" name="codeipmie" id="codeipmie" class="form-control"  placeholder="codeipmie" required /> -->
    ...
    <input type="number" name="salaire" id="salaire" class="form-control"  placeholder="Montant salaire" required /> 
        ...
        <div class="modal-footer row">
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="idEntreprise" id="idemployeur_id" value="<?php echo $_SESSION['session_idEntreprise']; ?>">
          ...
          <div class="col-md-3">
              ...
              <a class="btn btn-danger glyphicon glyphicon-log-out orange1 form-control" href="./">Suivant</a>
          </div>
        </div>
    </form>
    </div>
