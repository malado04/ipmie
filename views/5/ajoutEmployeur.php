...
$stmt->execute(array(":id"=>$_SESSION['user_session_inspecteur']));
...
$stmt1->execute(array(":id"=>$_SESSION['user_session_inspecteur']));
...
<!-- Ajouter un utilisateur -->
  ...
  <div class=" modal-lg" style="max-width: 1850px!important;"  role="document">
    <div class="modal-content">
      ...
      <h3 class="labelh">Créer un nouveau employeur </h3>       
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> 

        </div>
    <div class="etape row">
          <label class="col-md-2 label">Etape 1 / 5</label>   
          <label class="col-md-3 label1">Etape 2 / 5</label>   
   ...
   <div class="modal-body row">         
    ...
    <input type="number" name="cniemployeur" id="cniemployeur" class="form-control"  placeholder="CNI de l'employeur" required /> <br/> 
    <label>Nom de l'employeur</label>
    <input type="text" name="nomemployeur" id="nomemployeur" class="form-control"  placeholder="Nom de l'employeur" required /> <br/> 
    <label>Prénom de l'employeur</label>
    <input type="text" name="prenomemployeur" id="prenomemployeur" class="form-control"  placeholder="Prénom de l'employeur" required /><br/> 
    <label>Tel fixe de l'employeur</label>
    <input type="number" name="telfixemployeur" id="telfixemployeur" class="form-control"  placeholder="Tel fixe  de l'employeur" required /> 
    <label>Tel portable de l'employeur</label>
    <input type="number" name="telportemployeur" id="telportemployeur" class="form-control"  placeholder="Tel fixe  de l'employeur" required /> 
  </div> 
    <div class="col-md-6"> 
    <label>Commune de l'employeur</label>
    <input type="text" name="commune" id="commune" class="form-control"  placeholder="Commune de l'employeur" required />
    <label>Quartier de l'employeur</label>
    <input type="text" name="quartier" id="quartier" class="form-control"  placeholder="Quartier de l'employeur" required /> <br/> 
    <label>Email de l'employeur</label>
    <input type="email" name="email" id="email" class="form-control"  placeholder="Email de l'employeur" required />  
    <br/>  
    <label>Login de l'employeur</label>
    <input type="text" name="login" id="login" class="form-control"  placeholder="Login de l'employeur" required /> <br/> 
    <label>Mot de passe de l'employeur</label>
    <input type="text" name="password" id="password" class="form-control"  placeholder="Mot de passe de l'employeur" required />  <br/> 
    </div>
   </div> 
