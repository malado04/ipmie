...
$stmt->execute(array(":id"=>$_SESSION['user_session_inspecteur'], ":valide"=>$valide));
...
<tbody>
                        ...
                        echo '<tr>';
                            ...
                            if (($row['activedescentreprise']==0)) {
                                          # code...                            
                            echo ' <td><i class="btn btn-danger" data-toggle="tooltip" title="Edit">Non</i></td>';
                                        } else {
                                          # code...                            
                            echo ' <td><i class="btn btn-success" data-toggle="tooltip" title="Edit">Oui</i></td>';
