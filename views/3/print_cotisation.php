...
<table id="border" class="right padding" style="width:25%">
  <tr>  
   ...
   <br><br><br> Mode de paiement  :<br><br> <?php if (($userData1['banqueclient'])) {  
    echo $userData1['banqueclient']; echo "  / "; 
   echo $userData1['valeurrefcheque']; } else {  echo " ";}    ?> 
  <br><br><br> Décharge certifiée par: (IPM-IEZ)  : <?php if (($userData1['banqueclient'])) {  
    echo $userData1['banqueclient']; echo "  / "; 
  echo $userData1['valeurrefcheque']; } else {  echo " ";}    ?>
