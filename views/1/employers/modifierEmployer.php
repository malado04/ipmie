...
<div class="container">           
  <div class="" id="modifieremployer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        ...
        <div class="modal-footer row  bg-primary text-white">
          ...
          <div class="col-md-3">
            <input type="hidden" id="iduser" name="iduser" value="<?php echo $userRow['idEmployer']; ?>">
              <button type="submit" name="modifierEmployer" class="btn btn-primary glyphicon glyphicon-save orange1 form-control" > Enregister !</button> 
          </div>
          <div class="col-md-3">
