...
<table id="listeEmployert" class="table table-hover table-striped table-bordered" style="width:100%">
 ...
 <thead>
            <tr> 
              ...
              <th>Salaire</th> 
              <!-- <th>Cotisation</th>  -->
              <th>Ajout <br> Enfant</th> 
              <th>Ajout <br> Epouse</th> 
...
<tbody>
                        ...
                        echo '<tr class="tr">';
                            ...
                            echo '<td><a href="../ajoutEnfant1.php?id='.$row['idEmployer'].'" ><i class="btn btn-info" data-toggle="tooltip" title="Edit">Enfant !</i></a></td>';
                            echo '<td><a href="../ajoutEpouse1.php?id='.$row['idEmployer'].'" ><i class="btn btn-info" data-toggle="tooltip" title="Edit">Epouse !</i></a></td>';

                            if (($row['activedesc']==0)) {
                                          # code...                            
                            echo ' <td><a href="process.php?id_active='.$row['idEmployer'].'" ><i class="btn btn-info" data-toggle="tooltip" title="Edit">Activer</i></a></td>';

                                        } else {
                                          # code...                            
                            echo ' <td><a href="process.php?id_desc='.$row['idEmployer'].'" ><i class="btn btn-danger" data-toggle="tooltip" title="Edit">Desactiver</i></a></td>';

                                        }   
                                                    
                            echo ' <td><a href="transfer.php?id='.$row['idEmployer'].'" ><i class="btn btn-primary" data-toggle="tooltip" title="Edit">Transferer</i></a></td>';
                            echo ' <td><a href="modifierEmployer.php?id='.$row['idEmployer'].'" ><i class="btn btn-primary" data-toggle="tooltip" title="Edit">Modifier</i></a></td>';
                            echo '<td><a class="delete_employer" data-id="'.$row['idEmployer'].'" href="javascript:void(0)"><i class="btn btn-danger">Supprimer</i></a></td>';                          
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
...
$('#listeEmployert .tr').each(function() {
    ...
    // alert(customerId); 
    if (customerId==1) {
        $(".td").css("background-color","green"); //edit, body must be in quotes!
        }else{
        $(".td").css("background-color","red"); //edit, body must be in quotes!
        }
});
 
  $('.desactiver').click(function(e){
   ...
   bootbox.dialog({ 
     message: '<div id="modal"><img src="../../../img/btn-ajax-loader.gif" /><br/>Etes-vous sûr de vouloir desactiver cet employer ?</div>', 
    title: "<h3> Désactivation</h3> ! ",
     buttons: {
    success: {
      label: "Non, annuler",
    ...
    danger: {
      ...
      callback: function() {
       ...
       .fail(function(error){
        ...
        bootbox.alert('Erreur de Désactivation')+error;
