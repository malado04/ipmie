...
<!-- Ajouter un utilisateur -->
  ...
  <div class="modal-dialog modal-lg" style="max-width: 1800px!important;"  role="document">
    <div class="modal-content">
      ...
      <h3 class="labelh">Ajouter un(e) nouveau (lle) époux (se) </h3>       
   ...
   <div class="modal-body">         
    ...
    <div class="modal-footer row">
            ...
            <div class="col-md-3">
              <a href="employers/" class="btn btn-danger glyphicon glyphicon-log-out orange1 form-control">Terminer le processus</a>
