...
<body id="page-top">
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
                    <!-- <a href="ajoutEntreprise_.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" ><i class="fas fa-download fa-sm text-white-50"></i> Ajouter une entreprise</a> -->
                  </div>        
...
<thead>
            <tr> 
              ...
              <th>Nmbre d'hommes</th> 
              <th>Nmbre de femmes</th> 
              <th>Modifier !</th>   
              <!-- <th>Supprimer  !</th>    -->
            </tr>
</thead>
<tbody>
                        ...
                        $pid=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM entreprise, utilisateur WHERE utilisateur.id=entreprise.employeur_id ORDER BY idEntreprise DESC");  
                        ...
                        echo '<tr>';
                            ...
                            echo '<td>' . $row['numResgitreEntreprise'] . '</td>';
                            echo '<td>' . $row['nineaEntreprise'] . '</td>';
                            echo '<td>' . $row['dateImmatriculationEntreprise'] . '</td>';  
                            echo '<td>' . $row['hommeEntreprise'] . '</td>'; 
                            echo '<td>' . $row['femmeEntreprise'] . '</td>';   
                            echo '<td><a href="modifierEntreprise.php?idEntrepriseMod='.$row['idEntreprise'].'&id='.$row['employeur_id'].'"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Modifier ! </i></a></td>'; 
                            // echo '<td><a href="supprimerEntreprise_.php?idEntrepriseDel='.$row['idEntreprise'].'"><i class="btn btn-danger" data-toggle="tooltip" title="Edit"> Supprimer ! </i></a></td>'; 
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
