        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body row text-size">
                  <div class="col-md-3 bg-primary text-white">Enfant de moins de 5 ans de sex M</div>
                  <div class="col-md-3 arial"><?php echo $userRow1['nombre']; ?></div>
                  <div class="col-md-3 bg-primary text-white">Enfant de moins de 5 ans de sex F</div>
                  <div class="col-md-3 arial"><?php echo $userRow3['nombre']; ?></div>
                </div>
                <div class="card-body row text-size">
                  <div class="col-md-3 bg-primary text-white">Enfant compris entre 5 et 21 ans de sex M</div>
                  <div class="col-md-3 arial"><?php echo $userRow['nombre']; ?></div>
                  <div class="col-md-3 bg-primary text-white">Enfant compris entre 5 et 21 ans de sex F</div>
                  <div class="col-md-3 arial"><?php echo $userRow2['nombre']; ?></div>
                </div>
            </div>
        </div>
     </div>  
