...
<tbody>
                        ...
                        $statement = $pdo->prepare("SELECT * FROM entreprise, paiement WHERE entreprise.idEntreprise=paiement.entreprise_id AND  trie_jour=:createad ORDER BY idEntreprise DESC");  
                        $statement->execute(array('createad'=> $out[2]));  
