...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar"> 
      <li>
            <img class="rounded-circle img1" src="../../../img/IPMIEZ.png"> 
      </li>
      <!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse alert-danger" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="../logout.php"><i class="fa fa-fw fa-sign-out-alt"> Se déconnecter ici !</i> </a> 
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="../listepaiement.php">
          <i class="fa fa-fw fa-users"></i> Liste paiement </a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="../employeurs/">
          <i class="fa fa-fw fa-users"></i> Liste employeurs </a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="../employers/">
          <i class="fa fa-fw fa-users"></i> Liste employers </a>
      </li>
      <!-- Navs Item - utilisateurs et employers -->
       <li class="nav-item">
        <a class="nav-link" href="../fournisseurs/">
          <i class="fa fa-fw fa-users"></i> Fournisseurs </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../interompu.php">
          <i class="fa fa-fw fa-users"></i> Enregistrement interompu </a>
      </li>
      <!-- Navs Item - utilisateurs et employers -->
      <li class="nav-item">
        <a class="nav-link" href="../validercompte.php">
          <i class="fa fa-fw fa-users"></i> Valider compte utilisateur </a>
      </li> 
      <li class="nav-item">
...
<tbody>
                        ...
                        $pid=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM utilisateur, entreprise WHERE utilisateur.id=entreprise.employeur_id group by id");  
                        ...
                        echo '<tr>';
                            ...
                            echo ' <td><a href="../qr/qremployeur.php?id='.$row['idEntreprise'].'" ><i class="btn btn-primary" data-toggle="tooltip" title="Edit">Qrcode</i></a></td>';                            
                            if (($row['activedescentreprise']==0)) {
                                          # code...                            
                            echo ' <td><a href="process.php?id_active='.$row['idEntreprise'].'" ><i class="btn btn-info" data-toggle="tooltip" title="Edit">Activer</i></a></td>';
                                        } else {
                                          # code...                            
                            echo ' <td><a href="process.php?id_desc='.$row['idEntreprise'].'" ><i class="btn btn-danger" data-toggle="tooltip" title="Edit">Desactiver</i></a></td>';

                                        }                             
                            echo '<td><a class="modifier_employeur" data-id="'.$row['id'].'" href="javascript:void(0)"><i class="btn btn-success">Modifier</i></a></td>';                          
                            echo '<td><a class="delete_employeur" data-id="'.$row['id'].'" href="javascript:void(0)"><i class="btn btn-danger">Supprimer</i></a></td>';                          
...
<h1 class="alert-danger">Comptes utilisateurs validé</h1>

<table id="listeEmployert1" class="table table-hover table-striped table-bordered" style="width:100%">
...
<tbody>
                        ...
                        $valide=1;
                         $pdo->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING ); 
                         $statement = $pdo->prepare("SELECT * FROM utilisateur WHERE valide=:valide group by id");  
                        $statement->execute(array(':valide'=> $valide));  
                        $result = $statement->fetchAll();
...
<script type="text/javascript" src="script.js"></script>  
  ...
  // supprimer employers
   ...
   bootbox.dialog({ 
     message: '<div id="modal"><img src="../../../img/btn-ajax-loader.gif" /><br/>Etes-vous sûr de vouloir supprimer cet employeur ?</div>', 
    title: "<h3> Suppression</h3> <i class='glyphicon glyphicon-trash'></i> ! ",
     buttons: {
    success: {
      label: "Non, annuler",
    ...
    danger: {
      ...
      callback: function() {
       ...
       .fail(function(error){
        ...
        bootbox.alert('Erreur de Suppression')+error;
   ...
   bootbox.dialog({ 
     message: '<div id="modal"><img src="../../../img/btn-ajax-loader.gif" /><br/>Etes-vous sûr de vouloir supprimer cet utilisateur ?</div>', 
    title: "<h3> Suppression</h3> <i class='glyphicon glyphicon-trash'></i> ! ",
     buttons: {
    success: {
      label: "Non, annuler",
