...
$stmt = $pdo->prepare("SELECT * FROM fournisseur WHERE idfournisseur=:id");
...
<!-- Ajouter un utilisateur -->
  ...
  <div class=" modal-lg" style="max-width: 1850px!important;"  role="document">
   ...
   <div class="modal-body row">         
    <div class="col-md-6">
    <label>Matricule de l'fournisseur</label>
    <input type="text" name="matricule" id="matricule" value="<?php echo $userRow['matriculefournisseur']; ?>" class="form-control"  placeholder="Matricule de l'fournisseur" required /> <br/> 
    <label>Raison social de l'fournisseur</label>
    <input type="text" name="raisonsociale" value="<?php echo $userRow['raisonSocialefournisseur'];; ?>" id="raisonsociale" class="form-control"  placeholder="Raison social de l'fournisseur" required /><br/> 
    <label>Sigle de l'fournisseur</label>
    <input type="text" name="siglefournisseur" value="<?php echo $userRow['siglefournisseur'];; ?>" id="siglefournisseur" class="form-control"  placeholder="Sigle  de l'fournisseur" required /><br>
    <input type="text" name="pid" value="<?php echo $_GET['id'];?>" readonly class="form-control">
  </div> 
    <div class="col-md-6"> 
    <label>Numéro Resgitre fournisseur de l'fournisseur</label>
    <input type="text" name="numresgitrefournisseur" value="<?php echo $userRow['numResgitrefournisseur']; ?>" id="numresgitrefournisseur" class="form-control"  placeholder="Numéro Resgitre fournisseur de l'fournisseur" required /> <br/> 
    <label>Ninéa de l'fournisseur</label>
    <input type="text" name="nineafournisseur" value="<?php echo $userRow['nineafournisseur']; ?>" id="nineafournisseur" class="form-control"  placeholder="Ninéa de l'fournisseur" required /><br>
    <label>Date d'immatriculation l'fournisseur</label>
    <input type="date" name="dateimmatriculationfournisseur" value="<?php echo $userRow['dateimmatriculationfournisseur']; ?>" id="dateimmatriculationfournisseur" class="form-control"  placeholder="Date d'immatriculation l'fournisseur" required /> <br/> 
     
    <select name="typefournisseurMOD" class="form-control">
