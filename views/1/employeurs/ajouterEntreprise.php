...
<!-- Ajouter un utilisateur -->
  ...
  <div class=" modal-lg" style="max-width: 1850px!important;"  role="document">
    <div class="modal-content">
      ...
      <h3 class="labelh">Ajouter une entreprise </h3>       
   ...
   <div class="modal-body row">         
    ...
    <input type="text" name="matricule" id="matricule" class="form-control"  placeholder="Matricule de l'entreprise" /> <br/> 
    <label>Raison social de l'entreprise</label>
    <input type="text" name="raisonsociale" id="raisonsociale" class="form-control"  placeholder="Raison social de l'entreprise"/><br/> 
    <label>Sigle de l'entreprise</label>
    <input type="text" name="sigleentreprise" id="sigleentreprise" class="form-control"  placeholder="Sigle  de l'entreprise" /> <br/> 
    <label>Numéro Resgitre Entreprise de l'entreprise</label>
    <input type="text" name="numresgitreentreprise" id="numresgitreentreprise" class="form-control"  placeholder="Numéro Resgitre Entreprise de l'entreprise"/> <br/> 
    <label>Ninéa de l'entreprise</label>
    <input type="text" name="nineaentreprise" id="nineaentreprise" class="form-control"  placeholder="Ninéa de l'entreprise" />
  </div> 
    <div class="col-md-6"> 
    <label>Date d'immatriculation l'entreprise</label>
    <input type="date" name="dateimmatriculationentreprise" id="dateimmatriculationentreprise" class="form-control"  placeholder="Date d'immatriculation l'entreprise"/> <br/> 
    <label>Nombre d'hommes dans l'entreprise</label>
    <input type="number" name="hommeentreprise" id="hommeentreprise" class="form-control"  placeholder="Nombre de hommes dans l'entreprise"/> <br/> 
    <label>Nombre de femmes dans l'entreprise</label>
    <input type="number" name="femmeEntreprise" id="femmeEntreprise" class="form-control"  placeholder="Nombre de femmes dans l'entreprise"/> <br/> 
    <label>Periode Travail Entreprise</label>
    <input type="text" name="periodeTravailEntreprise" id="periodeTravailEntreprise" class="form-control"  placeholder="Periode Travail Entreprise"/> <br/> 
    <label>Période de travail</label>
    <input type="text" name="dateperiodetravail" id="dateperiodetravail" class="form-control"  placeholder="Periode Travail Entreprise"/>  <br/> 
    </div>
   </div>
