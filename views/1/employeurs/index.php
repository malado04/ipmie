...
<tbody>
                        ...
                        $pid=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM entreprise, utilisateur WHERE utilisateur.id=entreprise.employeur_id group by id");  
                        ...
                        echo '<tr>';
                            ...
                            echo ' <td><a href="ajouterEntreprise.php?id='.$row['id'].'" ><i class="btn btn-primary" data-toggle="tooltip" title="Edit">Entreprise</i></a></td>';                            
                            ...
                            echo '<td><a  href="modifierEmployeur.php?id='.$row['id'].'"><i class="btn btn-success">Fournisseur</i></a></td>';     
                            echo '<td><a  href="modifierEmployeur.php?id='.$row['id'].'"><i class="btn btn-success">Modifier</i></a></td>';                            
