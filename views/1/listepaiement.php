    ...
    <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar"> 
      ...
      <li class="nav-item">
        <a class="nav-link" href="listepaiement.php">
          <i class="fa fa-fw fa-users"></i> Paiement </a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="employeurs/">
          <i class="fa fa-fw fa-users"></i> Employeurs </a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="employers/">
          <i class="fa fa-fw fa-users"></i> Employers </a>
      </li>
       <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="interompu.php">
          <i class="fa fa-fw fa-users"></i> Enregistrement <br>interompu </a>
      </li>
      <!-- Navs Item - utilisateurs et employers -->
      <li class="nav-item">
        <a class="nav-link" href="validercompte.php">
          <i class="fa fa-fw fa-users"></i> Valider <br> compte  <br>utilisateur </a>
      </li> 
      <li class="nav-item">
      ...
      <h3 class="h">Bienvenue :  <?php echo $userRow['nom']; echo " "; echo $userRow['prenom']; echo " | <i class='fas fa-user fa-fw'></i> "; echo $userRow['posteoccupe']; ?></h3>
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
            <a href="ajoutEmployeur.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
              <i class="fas fa-download fa-sm text-white-50"></i> Ajouter un utilisateur</a>
          </div>      
        
<div class="modal-body ">  
<table id="listepaiement" class="table table-hover table-striped table-bordered" style="width:100%">
<thead>
            <tr>
              <th>Matricule</th>
              <th>Raison social</th>
...
<tbody>
                 ...
                 //           echo '<td>' . $row['idEmployeur'] . '</td>';
                            ...
                            echo ' <td><a href="ModifierPaiement.php?id='.$row['idpaiement'].'&id='.$row['idEntreprise'].'"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Modifier ! </i></a></td>'; 
                            echo '<td><a class="delete_paiement" data-id="'.$row['idpaiement'].'" href="javascript:void(0)"><i class="btn btn-danger">Supprimer</i></a></td>';                          
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
...
<script type="text/javascript" src="script.js"></script>  
  <script type="text/javascript">
    ...
    $('.delete_paiement').click(function(e){
