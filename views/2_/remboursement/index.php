...
<h2 class="text-center">Liste des remboursements</h2><br><br>
        <!-- Begin Page Content -->
        <div class="container-fluid">
...
<table id="paiement" class="table table-hover table-striped table-bordered" style="width:100%">
 ...
 <thead>
            <tr>
              <th>ID</th>
              <th>Nom <br> employer</th>
              <th>Prénom  <br> employer</th>
              <th>Code <br> employer</th>
              <th>IPM</th>   
              <th>Parent <br>patient</th>   
              <th>Total bon</th>   
              <th>Imprimer <br>remboursement <br>par client</th>   
              <th>Imprimer <br>remboursement <br>par entreprise</th>   
            </tr>
</thead>
<tbody>
                        ...
                        $statement = $pdo->prepare("SELECT * FROM employer, bondecommande WHERE employer.codeemployer=bondecommande.id_parent_p ORDER BY idEmployer DESC");  
                        ...
                        echo '<tr>';
                           echo '<td>' . $row['idEmployer'] . '</td>';
                            ...
                            echo '<td>' . $row['total_ipm'] . '</td>';
                            echo '<td>' . $row['total_parent'] . '</td>';
                            echo '<td>' . $row['total_bon'] . '</td>';
                            echo '<td style="width:10%;"><a href="../print_bon_client.php?id='.$row["codeemployer"].'" target="blank_"><i class="btn btn-success" data-toggle="tooltip" title="Edit"> <i class="fas fa-print fa-sm fa-fw mr-2 text-gray-400"></i></i></a></td>'; 
                            echo '<td style="width:10%;"><a href="../print_bon_client.php?id='.$row["idEmployer"].'" target="blank_"><i class="btn btn-success" data-toggle="tooltip" title="Edit"> <i class="fas fa-print fa-sm fa-fw mr-2 text-gray-400"></i></i></a></td>'; 
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
