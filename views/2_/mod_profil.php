...
<input type="file" id="imageenfant" name="imageenfant" class="form-control" required/> <br/> 
   </div> 
        <div class="modal-footer row">
          <div class="col-md-5">
          </div>
          <div class="col-md-3">
            <input type="hidden" id="id_Enfants" name="id_Enfants" value="<?php echo $_GET['id']; ?>">
              <button type="submit" name="photoEnfant" class="btn btn-primary glyphicon glyphicon-save orange1 form-control" > Enregister !</button> 
          </div>
          <div class="col-md-3">
              <button type="button" class="btn btn-danger glyphicon glyphicon-log-out orange1 form-control" data-dismiss="modal"> Annuler</button>
              <!-- <a class="btn btn-danger glyphicon glyphicon-log-out orange1 form-control" href="interompu.php">Retour</a> -->
