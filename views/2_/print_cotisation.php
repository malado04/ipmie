...
<div class="row">
  ...
  <h6 class="col-md-4">Période de cotisation : </h6><h6 class="col-md-8"> <?php  echo "Mois";  echo " / ";   echo "...................."; ?></h6>
...
<table id="border" class="left padding" style="width:70%">
  <tr> 
    ...
    <td class="center"><h4>SALAIRE BRUT <br> SOUMIS à <br> COTISATION</h4></td> 
     <?php 
    $statement = $pdo->prepare("SELECT * FROM entreprise, employer WHERE entreprise.idEntreprise=employer.employeur_id AND activedesc=:activedesc AND idEntreprise=:id  GROUP by idEmployer");  
    $statement->execute(array(":id"=>$_GET['id'], ":activedesc"=>$activedesc));  
  ...
  <tr> 
    ...
    <td class="center"><br><?php echo $userData1['montantsum'] ?></td>
  </tr>  
  <tr> 
    <td colspan="2"><b><br><br>Par employeur 3,5 % </b> </td>
    <td class="center"><br><br><?php echo $userData1['montantsum']*3.5/100 ?></td>
   </tr>    
  <tr> 
...
<!--   <tr> 
    ...
    <td class="center"><br><br><?php //echo $userData['montantsum']*7/100 ?></td>
  </tr>   
  <tr> 
...
<table id="border" class="right padding" style="width:25%">
  <tr>  
    <td><h4><br><br>N° Employeur :  <?php echo " "; echo $userData['matriculeEntreprise'] ?></h4> <br><br><br><br><br> Nombre de cotisants : <?php if (($userData1['nombre'])) {  echo $userData1['nombre']; } else {  echo " ";}    ?> 
   <br><br><br> Mode de paiement  :<br><br> <?php if (($userData['banqueclient'])) {  echo $userData['banqueclient']; echo "  / "; echo $userData['valeurrefcheque']; } else {  echo " ";}    ?> 
  <br><br><br> Décharge certifiée par: (IPM-IEZ)  : <?php if (($userData['banqueclient'])) {  echo $userData['banqueclient']; echo "  / "; echo $userData['valeurrefcheque']; } else {  echo " ";}    ?>
