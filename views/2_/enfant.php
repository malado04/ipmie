...
<!-- <meta http-equiv='refresh' content='50; url=#paiement'/> -->
        <table id="paiement" class="table table-hover table-striped table-bordered" style="width:100%">
          ...
          <tbody>
            ...
            $statement = $pdo->prepare("SELECT * FROM enfants WHERE (DATEDIFF(datenow, dateNaissanceEnfants)/365) <22 ORDER BY idEnfants DESC");  
            ...
            foreach ($result as $row) { 
              echo '<tr>';
                ...
                echo ' <td><a href="#ajoutPhoto" class="ajoutPhoto"  data-id="'.$row['idEnfants'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"><i class="fas fa-camera fa-sm fa-fw mr-2 text-gray-400"></i>Photo</i></a></td>';                             
                echo '<td><a class="delete_utilisateur" data-id="'.$row['idEnfants'].'" href="javascript:void(0)"><i class="btn btn-danger">Supprimer</i></a></td>';                          
...
<h2 class="text-center">Liste des enfants exclus</h2><br><br>
        <!-- Begin Page Content -->
        <div class="container-fluid">
<!-- <meta http-equiv='refresh' content='50; url=#paiement'/> -->
        <table id="enfantplus21" class="table table-hover table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              <th>ID ENFANT</th>
              <th>Image</th>
   ...
   bootbox.dialog({ 
    ...
    danger: {
      ...
      callback: function() {
       ...
       .fail(function(statut){
        
        bootbox.alert(statut);
