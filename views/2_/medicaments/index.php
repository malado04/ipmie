  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h3 class="h">Bienvenue :  <?php echo $userRow['nom']; echo " "; echo $userRow['prenom']; echo " | <i class='fas fa-user fa-fw'></i> "; echo $userRow['posteoccupe']; ?></h3>
        ...
        <a class="form btn btn-primary"  href="add_medicament.php">Ajouter un médicament</a>
...
<h2 class="text-center">Liste des medicaments</h2><br><br>
        <!-- Begin Page Content -->
        <div class="container-fluid">
...
<tbody>
                 ...
                 //           echo '<td>' . $row['idEmployeur'] . '</td>';
                            ...
                            echo '<td>' . $row['ipm'] . '</td>';
                            // echo ' <td><a href="process_medicament.php?id_medic='.$row["idMedicament"].'" target="blank_"><i class="btn btn-success" data-toggle="tooltip" title="Edit"> Activer ! </i></a></td>'; 
                             if (($row['ipm']=='oui')) {
                            echo ' <td><a href="process_medicament.php?id_medic_n='.$row['idMedicament'].'" ><i class="btn btn-danger" data-toggle="tooltip" title="Edit">Ne pas prendre en charge</i></a></td>';
                                          # code...                            
                                        } else {
                            echo ' <td><a href="process_medicament.php?id_medic='.$row['idMedicament'].'" ><i class="btn btn-success" data-toggle="tooltip" title="Edit">Pris en charge par IPMIEZ</i></a></td>';
                                          # code...                            
