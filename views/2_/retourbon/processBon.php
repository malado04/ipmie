...
$stmt = $pdo->prepare("SELECT * FROM entreprise WHERE matriculeEntreprise=:idEntreprise");
$stmt->execute(array(":idEntreprise"=>$_POST['idstructure']));
$entrepriseRow=$stmt->fetch(PDO::FETCH_ASSOC);
$count=count($entrepriseRow);

if ($count>1 && isset($_POST['medicament1']) && isset($_POST['prixmedi1']) && (!empty($_POST['medicament1']))) {
...
if ($count>1 && isset($_POST['medicament2']) && isset($_POST['prixmedi2']) && (!empty($_POST['medicament2']))) {
...
if ($count>1 && isset($_POST['medicament3']) && isset($_POST['prixmedi3']) && (!empty($_POST['medicament3']))) {
...
if ($count>1 && isset($_POST['medicament4']) && isset($_POST['prixmedi4']) && (!empty($_POST['medicament4']))) {
...
if ($count>1 && isset($_POST['medicament5']) && isset($_POST['prixmedi5']) &&  (!empty($_POST['medicament5']))) {
...
if ($count>1 && isset($_POST['medicament6']) && isset($_POST['prixmedi6']) &&  (!empty($_POST['medicament6']))) {
...
if ($count>1 && isset($_POST['medicament7']) && isset($_POST['prixmedi7']) &&  (!empty($_POST['medicament7']))) {
...
if ($count>1 && isset($_POST['medicament8']) && isset($_POST['prixmedi8']) && (!empty($_POST['medicament_']))) {
...
if ($count>1 && isset($_POST['medicament9']) && isset($_POST['prixmedi9']) && (!empty($_POST['medicament9']))) {
...
if ($count>1 && isset($_POST['medicament10']) && isset($_POST['prixmedi10']) && (!empty($_POST['medicament10']))) {
