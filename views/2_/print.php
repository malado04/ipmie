   ...
   <thead style="width: 100%;">
    ...
    <tbody>
      <tr>
        <td>Cotisation</td>
        <td> 
            <input type="text" value="<?php echo $userData['periodec'];  echo " "; echo " ";  echo $userData['datec']; ?>"> 
        </td>
        <td> 
      ...
      <td>Remboursement</td> 
        <td> 
            <input type="text" value="<?php echo $userData['perioder'];   echo " "; echo " ";  echo $userData['dater'];?>"> 
        </td>
        <td> 
            <input type="text" value="<?php echo $userData['remboursement']; ?>">
        </td>
        <td> 
            <input type="text"  value="<?php echo $userData['refcheque']; echo " "; echo " "; echo $userData['valeurrefcheque']; ?>">
