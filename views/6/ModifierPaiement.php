...
<div class="container">           
  ...
  <div class="modal-dialog modal-lg" style="max-width: 1000px!important;"  role="document">
   ...
   <div class="modal-body row">         
    ...
    <input type="number" name="telfixemployeur" id="telfixemployeur"mod class="form-control"  value="<?php echo $userRow['telFixe']; ?>" placeholder="Tel fixe  de l'employeur" required /> 
    ...
    <input type="text" name="commune" id="communemod" class="form-control"  value="<?php echo $userRow['adresseCommune']; ?>" placeholder="Commune de l'employeur" required />
