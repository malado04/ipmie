...
{
  header("192.168.1.155/apps/");
}
include_once '../../dao/database.php'; 
 
$pdo = Database::connect();  
$stmt1 = $pdo->prepare("SELECT * FROM employeur, utilisateur WHERE employeur.utilisateur_idEmployeur=utilisateur.id AND id=:id AND valide=:valide");
$stmt1->execute(array(":id"=>$_SESSION['user_session'], ":valide"=>1));
