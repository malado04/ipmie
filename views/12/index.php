...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar"> 
      ...
      <li class="nav-item active">
        <a class="nav-link" href="bon_commande/">
...
<tbody>
                        ...
                        $activedesc=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM entreprise, employer WHERE entreprise.idEntreprise= employer.employeur_id AND activedesc=:activedesc ORDER BY idEmployer DESC");  
                        $statement->execute(array('activedesc'=>$activedesc));  
                        ...
                        echo '<tr class="tr">';
                            ...
                            //  } else {
                              echo ' <td><a href="print.php?id_bon='.$row['idEmployer'].'" ><i class="btn btn-primary" data-toggle="tooltip" title="Edit">Imprimer</i></a></td>';                            
                              echo ' <td><a href="genererbon.php?id_bon='.$row['idEmployer'].'" target="_blank" ><i class="btn btn-success" data-toggle="tooltip" title="Edit">Génnérer un bon</i></a></td>';                            
                            // }
