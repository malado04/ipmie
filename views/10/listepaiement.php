...
<tbody>
                        ...
                        $pid=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM Entreprise, paiement, utilisateur WHERE utilisateur.id= paiement.iduser ORDER BY id DESC");  
                        ...
                        echo '<tr>';
                            ...
                            echo ' <td><a href="#modificationPaiement" class="modificationPaiement"  data-id="'.$row['idpaiement'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Modifier ! </i></a></td>'; 
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
