...
-->
 ...
 <h1 class="alert-danger">Enregistrement interrompu</h1>
<table id="utilisateur" class="table table-hover table-striped table-bordered" style="width:100%">
...
<tbody>
                        ...
                        $pid=1;
                         ...
                         $statement = $pdo->prepare("SELECT * FROM utilisateur ORDER BY id DESC");  
                        ...
                        echo '<tr>';
                            ...
                            echo ' <td><a href="#ajoutEntreprise" class="ajoutEmployer" 
                            href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary fas fa-download " data-toggle="tooltip" title="Edit">Ajouter</i></a></td>';
                            // echo ' <td><a href="#modifierEmployeur" class="modifierEmployeur"  
                            // data-id="'.$row['id'].'"  
                            // data-cni="'.$row['cni'].'"  
                            // data-nom="'.$row['nom'].'"  
                            // data-prenom="'.$row['prenom'].'"  
                            // data-telfixe="'.$row['telFixe'].'"  
                            // data-telportable="'.$row['telPortable'].'"  
                            // data-adressecommune="'.$row['adresseCommune'].'"  
                            // data-email="'.$row['email'].'"  
                            // data-adresse="'.$row['adresse'].'"  
                            // data-posteoccupe="'.$row['posteoccupe'].'"  
                            // data-login="'.$row['login'].'"  
                            // data-password="'.$row['password'].'" 
                            // href="javascript:void(0)" data-toggle="modal"><i class="btn btn-warning" data-toggle="tooltip" title="Edit">Modifier</i></a></td>';        
                            echo '<td><a href="modifierEmployeur.php?id='.$row['id'].'"><i class="btn btn-sucess">Modifier</i></a></td>';                          
 ...
 <?php include_once 'modifierEmployeur.php'; ?>
...
//     var cni = $(this).attr('data-cni');
//     var nom = $(this).attr('data-nom');
//     var prenom = $(this).attr('data-prenom');
//     var adresse = $(this).attr('data-adresse');
//     var telfixe = $(this).attr('data-telfixe');
//     var telportable = $(this).attr('data-telportable');
//     var adressecommune = $(this).attr('data-adressecommune');
//     var email = $(this).attr('data-email');
//     var posteoccupe = $(this).attr('data-posteoccupe');
//     var password = $(this).attr('data-password');
// alert(cni);
//     $('iduser').val(iduser);
//     $('cniemployeurmod').val(cni);
//     $('nomemployeurmod').val(nom);
//     $('prenomemployeurmod').val(prenom);
//     $('telfixemployeur').val(telfixe);
//     $('telportemployeurmod').val(telportable);
//     $('communemod').val(adressecommune);
//     $('quartiermod').val(adresse);
//     $('emailmod').val(email);
//     $('loginmod').val(login);
         ...
         {            
          if(response==1){  
           bootbox.dialog({ 
            ...
            setTimeout('window.location.href = "https://ipmiez.com/views/1/"; ',1500);
          }
          else{
              bootbox.dialog({ 
            size: "small",
              message: '<div id="modal"><img id="imgbootbox" src="https://ipmiez.com/bootstrap/images/btn-ajax-loader1.gif" /><br/></div>'+response});
               setTimeout('window.location.href = "https://ipmiez.com/views/1/"; ',2000);
      ...
      success :  function(response)
         {            
          if(response==1){  
           ...
           //  setTimeout('window.location.href = "https://ipmiez.com/ipmieziguinchor/administrateur/index.php"; ',2000);
