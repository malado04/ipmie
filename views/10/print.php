...
<link rel="stylesheet" type="text/css" href="http://192.168.1.10/apps/bootstrap/css/bootstrap.css">
<style type="text/css">
 .text-right{
    float: right;
  }
   ...
   <thead style="width: 100%;">
    ...
    <tbody>
      <tr>
        <td>Cotisation</td>
        <td> 
            <input type="text" value="<?php echo $userData['periodec']; ?>"> 
        </td>
        <td> 
      ...
      <td>Remboursement</td> 
        <td> 
            <input type="text" value="<?php echo $userData['perioder']; ?>"> 
        </td>
        <td> 
