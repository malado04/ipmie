...
<tbody>
                        ...
                        echo '<tr class="tr">';
                            ...
                            // echo ' <td><a href="#" class="ajoutEmployer activer"  data-id="'.$row['idEmployer'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-success" data-toggle="tooltip" title="Edit">Activer</i></a></td>';
                            echo ' <td><a href="../process.php?id_active='.$row['idEmployer'].'" ><i class="btn btn-success" data-toggle="tooltip" title="Edit">Activer</i></a></td>';
...
$('#listeEmployert .tr').each(function() {
  ...
  $('.desactiver').click(function(e){
   ...
   bootbox.dialog({ 
    ...
    title: "<h3> Désactivation</h3> <i class='glyphicon glyphicon-trash'></i> ! ",
     buttons: {
    success: {
      label: "Non, annuler",
