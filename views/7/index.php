...
-->
      ...
      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          ...
          <span><a href="https://ipmiez.com/views/secretaire/liste_entreprise.php">Liste des medicaments</a></span></a>
      </li>
      <!-- Divider -->
...
<tbody>
                 ...
                 //           echo '<td>' . $row['idEmployeur'] . '</td>';
                            ...
                            // echo '<td>' . $row['banqueclient'] . '</td>'; 
                            echo ' <td><a href="#ajoutPaiement" class="ajoutPaiement"  data-id="'.$row['idEntreprise'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Paiement ! </i></a></td>'; 
                            echo ' <td><a href="#ajoutremboursement" class="ajoutremboursement"  data-id="'.$row['idEntreprise'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Paiement due ! </i></a></td>'; 
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
                     ?> 
...
<?php include('add_remboursement.php'); ?>
...
<script type="text/javascript">
  ...
  $("#idpaiement").val(idpaiement);   
   ...
   var idajoutremboursement = $(this).attr('data-id'); 
   // alert(idajoutremboursement);

  $("#idajoutremboursement").val(idajoutremboursement);   
