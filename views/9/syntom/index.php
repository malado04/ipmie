  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-briefcase-medical"> <b>Choix de symptomes</b></i></h5>
      ...
      <form action="process.php" method="post">
        ...
        <script type="text/javascript">
         ...
         <fieldset class="fieldsetx ">
          <legend>Choix des symptomes</legend>
          <!-- <input list="medic" class="form-control" name="id_beneficiaire_en"> -->
           <select id="syntome_select[]"  name="syntome_select[]" multiple="multiple" class="form-control" >
            <?php  $pdo =Database::connect();
                         $pdo->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING ); 
                           $statement = $pdo->prepare("SELECT * FROM syntome");  
                        $statement->execute(array());  
                        $result = $statement->fetchAll();
                        foreach ($result as $row) { //on cree les lignes du tableau avec chaque valeur 
                        ?>
                          <option class="option" value="<?php echo $row['libelle_sy']; ?>"><?php echo $row['libelle_sy'];?></option> 
                        <?php 
                          }
                        Database::disconnect();  
                     ?> 
          ...
          <div class="modal-footer bg-primary text-white">
            <input type="hidden" name="idEmplo" id="idEmplo" value="<?php echo $_GET['id']; ?>">
