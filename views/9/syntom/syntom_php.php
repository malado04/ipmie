...
<div class="" id="id_consultation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="col-md-12">   
           <legend>Choix des symptômes </legend>
           <select id="symptom" name="symptom[]" multiple="multiple" class="form-control" required="">
          ...
          <div class="modal-footer bg-primary text-white">
            <input type="hidden" class="form-control" name="idEmployer" value="<?php echo $_GET['emp'];?>">
            <input type="hidden" class="form-control" name="idconsul" value="<?php echo $_GET['idc'];?>">
