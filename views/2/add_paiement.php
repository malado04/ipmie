...
<div class="row">           
  ...
  <div class="modal-dialog modal-lg" style="max-width: 1250px!important;"  role="document">
   ...
   <div class="modal-body row">         
    ...
    <input type="text" list="periodecl" name="periodec" id="periodec" class="form-control">
    <datalist id="periodecl">
      ...
      <option value="1eme_Trimestre">1<sup>ère</sup> Trimestre</option> 
      <option value="2eme_Trimestre">2<sup>ème</sup> Trimestre</option> 
      <option value="3eme_Trimestre">3<sup>ème</sup> Trimestre</option> 
      <option value="4eme_Trimestre">4<sup>ème</sup> Trimestre</option> 
      <option value="1ere_Semestre"> Semestre 1</option> 
      <option value="2eme_Semestre"> Semestre 2</option> 
      <option value="_Annee"> Année</option> 
    </datalist>
    ...
    <input type="text" list="perioderl" name="perioder" id="perioder" class="form-control">
...
<div class="col-md-12"> 
  <label>Date cheque</label>
    <input type="date" name="datecheque" class="form-control">
</div>    
   </div>
        ...
        <div class="modal-footer row">
          ...
          <div class="col-md-3">
            ...
            <button type="submit" class="btn btn-primary   glyphicon glyphicon-save orange1 form-control orange1" > Enregister et Imprimer reçu ! </button> 
          </div>
          <div class="col-md-3">
