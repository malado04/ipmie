...
<div class="container">           
 ...
 <br>
  ...
  <div class="col-md-4">
      ...
      <?php  
      $statement1 = $pdo->prepare("SELECT * FROM fournisseur ORDER BY idFournisseur DESC");  
      $statement1->execute(array());  
      $result1 = $statement1->fetchAll();
      foreach ($result1 as $row1) { 
      //on cree les lignes du tableau avec chaque valeur 
      ?>
      <option value="<?php echo $row1['matriculefournisseur']; ?>"><?php echo $row1['raisonSocialefournisseur']; echo " "; echo $row1['raisonSocialefournisseur']; ?></option>
      <?php 
      }
      Database::disconnect();  
      ?> 
