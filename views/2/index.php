  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar"> 
     ...
     <!--  <li class="nav-item active">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="retourbon/">
          <span>Gérer bon</span></a> 
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h3 class="h">Bienvenue :  <?php echo $userRow['nom']; echo " "; echo $userRow['prenom']; echo " | <i class='fas fa-user fa-fw'></i> "; echo $userRow['posteoccupe']; ?></h3>
        ...
        <div class="container-fluid">
          <button class="form-control btn-primary"  data-toggle="modal" data-target="#modifierImage">Ajouter un médicament</button>
...
<tbody>
                 ...
                 //           echo '<td>' . $row['idEmployeur'] . '</td>';
                            ...
                            // echo '<td>' . $row['valeurrefcheque'] . '</td>'; 
                            echo '<td>' . $row['banqueclient'] . '</td>'; 
                            echo ' <td><a href="print.php?id='.$row["idpaiement"].'" target="blank_"><i class="btn btn-success" data-toggle="tooltip" title="Edit"> Versement ! </i></a></td>'; 
                            echo ' <td><a href="print_cotisation.php?id='.$row["idEntreprise"].'" target="blank_"><i class="btn btn-info" data-toggle="tooltip" title="Edit"> Cotisation ! </i></a></td>'; 
                            echo ' <td><a href="print_cotisationtrimestre.php?id='.$row["idEntreprise"].'" target="blank_"><i class="btn btn-info" data-toggle="tooltip" title="Edit"> Cotisation</br> trimestrielle ! </i></a></td>'; 
                            echo ' <td><a href="print_cotisationsemestre.php?id='.$row["idEntreprise"].'" target="blank_"><i class="btn btn-info" data-toggle="tooltip" title="Edit"> Cotisation </br>semestrielle ! </i></a></td>'; 
                            echo ' <td><a href="print_cotisationannee.php?id='.$row["idEntreprise"].'" target="blank_"><i class="btn btn-info" data-toggle="tooltip" title="Edit"> Cotisation </br> annuelle! </i></a></td>'; 
                            echo ' <td><a href="#ajoutPaiement" class="ajoutPaiement"  data-id="'.$row['idEntreprise'].'" href="javascript:void(0)" data-toggle="modal"><i class="btn btn-primary" data-toggle="tooltip" title="Edit"> Paiement ! </i></a></td>'; 
                        echo '</tr>'; 
                        }
                        Database::disconnect();  
