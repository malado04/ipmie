...
<h6 class="">Rue Générale DEGAULLE X FODE KABA DOUMBOUYA</h6>    
  ...
  <div class="col-md-8">
    <h2 class="text-center arial" >ETAT ANNUEL<br> COTISATION ET REMBOURSEMENT<br> FRAIS MEDICAUX</h2>
...
<div class="row">
  ...
  <h6 class="col-md-4">Période de cotisation : </h6><h6 class="col-md-8"> <?php  echo "Année";  echo " / ";   echo "...................."; ?></h6>
...
<table id="border" class="left padding" style="width:70%">
  ...
  <tr> 
    ...
    <td class="center"><br><?php echo $userData1['montantsum']*12; ?></td>
  </tr>  
  <tr> 
    <td colspan="2"><b><br><br>Par employeur 3,5 % </b> </td>
    <td class="center"><br><br><?php echo ($userData1['montantsum']*3.5/100)*12; ?></td>
   </tr>    
  <tr> 
  ...
  <tr> 
    ...
    <td class="center"><br><br><?php echo ($userData1['montantsum']*7/100)*12; ?></td>
  </tr>  
  <tr> 
